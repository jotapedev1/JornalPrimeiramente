...
const OtherResourcesScreen = ({navigation}) => {
    const data=[
        {id: 1, name: 'Notas de Versão', route: 'VersionNotes'},
        {id: 2, name: 'Política de Cookies', route: 'CookiesPolicy'},
        {id: 3, name: 'Política de Privacidade', route: 'PrivacyPolicy'},
        {id: 4, name: 'Termos de Serviço', route: 'TermsOfService'},
        {id: 5, name: 'Central de Ajuda', route: 'Help'},
        {id: 6, name: 'Sobre', route: 'About'},
    ];
...
export default OtherResourcesScreen;